    ...
    <div className={`fs-player${closing ? ' closing' : ''}`} role="dialog" aria-label="Full player" aria-modal="true">
      ...
      <div className="fs-content">
        <div className="fs-layout">
          <section className="fs-main-card">
            ...
            {hasSong ? (
              <>
                ...
                <div className="fs-volume-row">
                  <span className="fs-volume-label">Volume</span>
          ...
          {hasSong ? (
            <aside className="fs-lyrics-panel" aria-label="Lyrics and chords panel">
              <LyricsChordsPanel showCloseButton={false} />
            </aside>
          ) : null}
        </div>
      </div>
