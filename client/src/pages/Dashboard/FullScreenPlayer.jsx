  ...
  return (
    <div className="fs-player">
      ...
      <div className="fs-top">
        <button className="fs-close-btn" type="button" aria-label="Close full screen player" onClick={onClose}>
      ...
      <div className="fs-content">
        <div className="fs-poster-wrap">
          <img className="fs-poster" src={poster} alt={song ? `${song.title} artwork` : 'No song'} onError={(e) => { e.target.src = DEFAULT_POSTER; }} />
        </div>

        <div className="fs-song-info">
          <div className="fs-title">{song?.title || 'No Song Selected'}</div>
          <div className="fs-artist">{song?.artist || ''}</div>
        ...
        <div className="fs-controls">
          ...
          <button className="fs-play-btn" type="button" aria-label={player.isPlaying ? 'Pause' : 'Play'} onClick={player.togglePlay}>
