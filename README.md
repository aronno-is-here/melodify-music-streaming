...
- **Out of scope** — Admin navigation UI (**40/43**), model-quality dashboard widgets (**41/43**), richer model-history/dataset-stats surfaces (**42/43**), auth-matrix hardening tests (**39/43**).
