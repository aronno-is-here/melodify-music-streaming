...
│   ├── routes/                    # /api/auth, /api/songs, /api/playlists, /api/history, /api/subscriptions, /api/admin, /api/listening-events, /api/trending, /api/recommendations
...
- **Out of scope** — Admin recommendation-metrics API (**38/43**), snapshot writing, second feature flag, Python execution.
