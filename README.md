...
- The Premium promotion uses a navy/violet surface and original local `client/public/home/premium-crown.svg` artwork, with no third-party branded imagery. The decorative right-hand crown yields to the compact gold badge on narrow screens so the copy retains its space.
