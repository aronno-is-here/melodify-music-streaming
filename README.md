...
| Not present | cold-start fallback (31/43), exploration, Favorite/Playlist explicit-evidence integration, snapshot/artifact publication, retraining, HTTP/MongoDB, Dashboard changes |
| Next | **31/43** owns cold-start / fallback / explicit-evidence policy for users and Songs this ranker rejects |
