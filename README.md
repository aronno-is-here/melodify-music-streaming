...
│   │   ├── Dashboard/             # Music dashboard + player + Trending Now (22/43) + recommendationUi (36/43)
...
- **Out of scope** — Dashboard integration (**37/43**), admin evaluation UI, Python execution, snapshot writing, second feature flag.
...
- **Out of scope** — no Dashboard `Recommended For You` section (**37/43**), no player/`PlayHistory`/`ListeningEvent` side effects, no client-side scoring/normalization/hybrid/exploration, no new npm dependencies.

```bash
node --test client/src/services/personalizedRecommendations.test.js client/src/pages/Dashboard/recommendationUi.test.js
```
