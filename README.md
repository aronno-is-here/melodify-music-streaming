...
- **Global + full-screen audio player surfaces** — persistent desktop player bar and mobile mini-player across shell routes, plus a modernized full-screen player with safe-area handling, lyrics/chords panel toggle, engine-confirmed playback status messaging, retry action, and complete transport controls
